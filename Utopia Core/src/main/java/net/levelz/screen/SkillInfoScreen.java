...
public class SkillInfoScreen extends Screen implements Tab {
    ...
    protected void init() {
        ...
        case "alchemy":
            ...
            break;
        default:
            // Fähigkeiten aus der Registry: Beschreibung kommt aus der
            // Sprachdatei. Fehlt der Schlüssel, filtert die Liste ihn weg.
            this.translatableText1A = Text.translatable("text.levelz." + this.title + "_info_1");
            this.translatableText1B = Text.translatable("text.levelz." + this.title + "_info_2");
            break;
        }
