...
public abstract class PlayerEntityMixin extends LivingEntity
        implements PlayerStatsManagerAccess, PlayerDropAccess, dev.utopia.core.character.CharacterAccess {
    ...
    // Utopia: Charakterdaten haengen an derselben Mixin-Instanz - keine zweite Injection noetig.
    private final dev.utopia.core.character.CharacterData utopiaCharacter = new dev.utopia.core.character.CharacterData();
    ...
    public void readCustomDataFromNbtMixin(NbtCompound tag, CallbackInfo info) {
        ...
        this.utopiaCharacter.readNbt(tag);
    ...
    public void writeCustomDataToNbtMixin(NbtCompound tag, CallbackInfo info) {
        ...
        this.utopiaCharacter.writeNbt(tag);
    }
    ...
    @Override
    public dev.utopia.core.character.CharacterData utopia$getCharacter() {
        return this.utopiaCharacter;
    }
