...
public abstract class ServerPlayerEntityMixin extends PlayerEntity implements PlayerSyncAccess {
    ...
    private void copyFromMixin(ServerPlayerEntity oldPlayer, boolean alive, CallbackInfo info) {
        syncStats(false);
        // Utopia: Charakterwahl ueberlebt Tod und Dimensionswechsel.
        ((dev.utopia.core.character.CharacterAccess) this).utopia$getCharacter()
                .copyFrom(((dev.utopia.core.character.CharacterAccess) oldPlayer).utopia$getCharacter());
    }
