...
public abstract class WanderingTraderEntityMixin extends MerchantEntity {
    ...
    protected void afterUsingMixin(TradeOffer offer, CallbackInfo info, int i) {
        if (ConfigInit.CONFIG.tradingXPMultiplier > 0.0F)
            LevelExperienceOrbEntity.spawn((ServerWorld) this.getWorld(), this.getPos().add(0.0D, 0.5D, 0.0D), dev.utopia.core.skill.XpBonus.apply(this.getCustomer(), net.levelz.stats.Skill.TRADE, (int) (i * ConfigInit.CONFIG.tradingXPMultiplier
